...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6831947029 5324831370 6444128136').split()] # For Multiple Id Use One Space Between Each.
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'OrzzFilter')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+O3pt4CavkWM5OWI9')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Itsstoic')
